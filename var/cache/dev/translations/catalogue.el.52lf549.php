...
$catalogue = new MessageCatalogue('el', array (
  ...
  'EasyAdminBundle' => 
  array (
    'new.page_title' => 'Δημιουργία %entity_label%',
    'show.page_title' => '%entity_label% (#%entity_id%)',
    'edit.page_title' => 'Επεξεργασία %entity_label% (#%entity_id%)',
    'list.page_title' => '%entity_label%',
    'search.page_title' => '{0} Δεν βρέθηκαν αποτελέσματα|Βρέθηκε <strong>1</strong> αποτέλεσμα|]1,Inf]Βρέθηκαν <strong>%count%</strong> αποτελέσματα',
    'search.no_results' => 'Δεν βρέθηκαν αποτελέσματα.',
    'list.row_actions' => 'Ενέργειες',
    ...
    'show.remaining_items' => '{1} υπάρχει άλλο ένα αντικείμενο που δεν εμφανίζεται σε αυτή την λίστα|]1,Inf] %count% ακόμα αντικείμενα δεν εμφανίζονται σε αυτή την λίστα',
    ...
    'exception.no_entities_configured' => 'Η εφαρμογή δεν είναι ρυθμισμένη σωστά.',
    'exception.undefined_entity' => 'Η εφαρμογή δεν έχει ρυθμιστεί σωστά για τέτοιου είδους αντικείμενα.',
