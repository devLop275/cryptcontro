...
$catalogue = new MessageCatalogue('bg', array (
  ...
  'EasyAdminBundle' => 
  array (
    'new.page_title' => 'Създаване на %entity_label%',
    'show.page_title' => '%entity_label% (#%entity_id%)',
    'edit.page_title' => 'Редактиране на %entity_label% (#%entity_id%)',
    ...
    'exception.no_entities_configured' => 'Приложението не е конфигурирано правилно.',
    'exception.undefined_entity' => 'Приложението не е конфигурирано правилно за този вид елементи.',
    'login.username' => 'Потребителско има',
    'login.password' => 'Парола',
    'login.sign_in' => 'Вход',
  ),
  'messages' => 
  array (
    'action.new' => 'Добавяне на %entity_label%',
    'action.show' => 'Преглед',
