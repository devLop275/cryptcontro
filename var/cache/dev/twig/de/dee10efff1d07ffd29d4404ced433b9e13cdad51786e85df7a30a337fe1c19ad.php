...
class __TwigTemplate_253dfe0aaa752413bde871de9fa485e934347316c3eda7ad3674b5eb0ff39d20 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 7
        echo nl2br(twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("resetting.check_email", ["%tokenLifetime%" => (isset($context["tokenLifetime"]) || array_key_exists("tokenLifetime", $context) ? $context["tokenLifetime"] : (function () { throw new RuntimeError('Variable "tokenLifetime" does not exist.', 7, $this->source); })())], "FOSUserBundle"), "html", null, true));
        echo "
</p>
";
...
{% endblock %}
", "FOSUserBundle:Resetting:check_email.html.twig", "/opt/lampp/htdocs/testrapide/vendor/friendsofsymfony/user-bundle/Resources/views/Resetting/check_email.html.twig");
    }
}
