...
class __TwigTemplate_4fbf2b69ffc7ee2350cea432e7f2a28af5d53bfb458d9dd1538eb94b685d02bc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
(isset($context["delete_form"]) || array_key_exists("delete_form", $context) ? $context["delete_form"] : (function () { throw new RuntimeError('Variable "delete_form" does not exist.', 3, $this->source); })()), "vars", [], "any", false, false, false, 3), "action", [], "any", false, false, false, 3) . ((twig_in_filter("?", twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["delete_form"]) || array_key_exists("delete_form", $context) ? $context["delete_form"] : (function () { throw new RuntimeError('Variable "delete_form" does not exist.', 3, $this->source); })()), "vars", [], "any", false, false, false, 3), "action", [], "any", false, false, false, 3))) ? ("&") : ("?"))) . "referer=") . twig_urlencode_filter((isset($context["referer"]) || array_key_exists("referer", $context) ? $context["referer"] : (function () { throw new RuntimeError('Variable "referer" does not exist.', 3, $this->source); })()))), "method" => "DELETE", "attr" => ["id" => "delete-form", "style" => "display: none"]]);
        // line 7
        echo "
...
";
    ...
    {
        return array (  95 => 28,  88 => 25,  82 => 24,  77 => 23,  74 => 22,  72 => 21,  66 => 18,  59 => 14,  55 => 13,  47 => 7,  45 => 3,  44 => 2,  43 => 1,);
    }
...
", "EasyAdminBundle:default/includes:_delete_form.html.twig", "/opt/lampp/htdocs/testrapide/vendor/easycorp/easyadmin-bundle/src/Resources/views/default/includes/_delete_form.html.twig");
    }
}
